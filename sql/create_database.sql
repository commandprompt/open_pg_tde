...
SELECT open_pg_tde_add_database_key_provider_file('file-vault', '/tmp/template_provider.per');
...
SELECT open_pg_tde_add_global_key_provider_file('global-file-vault','/tmp/template_provider_global.per');
SELECT open_pg_tde_create_key_using_global_key_provider('default-key', 'global-file-vault');
SELECT open_pg_tde_set_default_key_using_global_key_provider('default-key', 'global-file-vault');
...
SELECT open_pg_tde_is_encrypted('test_enc_id_seq');
...
SELECT open_pg_tde_is_encrypted('test_plain_id_seq');
...
SELECT open_pg_tde_delete_global_key_provider('global-file-vault');
