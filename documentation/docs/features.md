...
* Single-tenancy support via a [global keyring provider](key-management/set-principal-key.md)
* [Multi-tenancy support](how-to/multi-tenant-setup.md)
* Table-level granularity for encryption and access control
* Multiple [Key management options](key-management/overview.md)

## Next steps

Learn more about how `open_pg_tde` implements Transparent Data Encryption:

[About Transparent Data Encryption :material-arrow-right:](concepts/about-tde.md){.md-button}
