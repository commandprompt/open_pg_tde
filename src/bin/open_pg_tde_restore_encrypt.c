...
#include "open_pg_tde_fe_archive_common.h"
...
static char tmpdir[MAXPGPATH] = TMPFS_DIRECTORY "/open_pg_tde_restoreXXXXXX";
...
main(int argc, char *argv[])
{
	...
	if (argc > 1)
	{
		...
		{
			puts("open_pg_tde_restore_encrypt (PostgreSQL) " PG_VERSION);
			exit(0);
		}
	}
